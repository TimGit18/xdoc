...
/**
 * Die Klasse TextProcessor ist eine Musterklasse für die Verarbeitung der Themadokumente und der
...
public class TextProcessor  {
    ...
    static Logger LOG = LogManager.getLogger(TextProcessor.class.getName());
     ...
     * Der relative Pfad muss um den prePath ergänzt werden, der den Level des Dokuments repr�sentiert.
     ...
     * HTML-Pfad muss um den prePath ergänzt werden, der den Level des Dokuments repr�sentiert.
     */
     ...
     * Der relative Script-Pfad muss um den prePath ergänzt werden, der den Level des Dokuments repr�sentiert.
